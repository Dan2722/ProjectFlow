        ...
        <div class="client-card p-3 rounded-3 w-100 border">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    ...
                    <div class="company-name text-muted" style="font-size: 13px;">{{ $client->company_name }}</div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal text-center p-4">
            <form id="deleteClientForm" method="POST" action="">
                @csrf
                @method('DELETE')
                <p class="delete-text mb-4 fw-bold" id="deleteClientModalText">هل تريد حذف هذا العميل؟</p>
