...
<main class="login-wrapper text-center w-100 px-3">
    ...
    <!-- حوّلنا الزر إلى نوع button وربطناه بدالة مباشرة -->
    <button class="btn btn-login w-100 py-2 fw-semibold" id="resetSubmitBtn" type="button" onclick="checkEmailAndSubmit()">إرسال رابط التعيين</button>
</form>
        </div>

        <!-- واجهة النجاح (مخفية افتراضياً وتظهر بعد الإرسال الصحيح) -->
